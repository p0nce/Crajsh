...
tron.Sound = function(title, ssrc, streaming, baseVolume)
{
...
tron.Sound.prototype = 
{
    ...
    _load : function()
    {
	    ...
	    this._dom.load();
	    //this._duration = this._streaming ? 0 : this._dom.duration; // unknown
	    //alert(this._title + " = " + this._duration + "s");
    },
